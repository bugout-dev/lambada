"""
Simple lambda which extracts EXIF tags from an image in a Simiotics data source and registers
the new metadata against another (possibly the same) data source.
"""
